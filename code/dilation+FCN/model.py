...
def generator_simplified_api(x, is_train=True, reuse=False):
    batch_size=16
    n_out=1
    pad='SAME'
    ...
    with tf.variable_scope("u_net", reuse=reuse):
        ...
        conv1_0 = DepthwiseConv2d(inputs, (3, 3), (2, 2),depth_multiplier=64, padding=pad, dilation_rate=[1,1], W_init=w_init, b_init=b_init, name='conv1_0')
        conv1_1 = DepthwiseConv2d(inputs, (3, 3), (2, 2),depth_multiplier=64, padding=pad, dilation_rate=[2,2], W_init=w_init, b_init=b_init, name='conv1_1')
        #conv1_2 = DepthwiseConv2d(inputs, (3, 3), (2, 2),depth_multiplier=64, padding=pad, dilation_rate=[3,3], W_init=w_init, b_init=b_init, name='conv1_2')
        conv1_3 = DepthwiseConv2d(inputs, (3, 3), (2, 2),depth_multiplier=64, padding=pad, dilation_rate=[4,4], W_init=w_init, b_init=b_init, name='conv1_3') 
        conv1 = ConcatLayer([conv1_0, conv1_1], concat_dim=3, name='concat_conv1')
        #conv1 = ConcatLayer([conv1, conv1_2], concat_dim=3, name='concat_conv2')
        conv1 = ConcatLayer([conv1, conv1_3], concat_dim=3, name='concat_conv3')
        ...
        # exit()
        # print(nx/8)
        up7 = DeConv2d(conv8, 1024, (4, 4), out_size=(4, 4), strides=(2, 2),
        ...
        up6 = DeConv2d(up6, 1024, (4, 4), out_size=(8, 8), strides=(2, 2),
        ...
        up5 = DeConv2d(up5, 1024, (4, 4), out_size=(16, 16), strides=(2, 2),
        ...
        up4 = DeConv2d(up4, 1024, (4, 4), out_size=(32, 32), strides=(2, 2),
        ...
        up3 = DeConv2d(up3, 256, (4, 4), out_size=(64, 64), strides=(2, 2),
        ...
        up2 = DeConv2d(up2, 128, (4, 4), out_size=(128, 128), strides=(2, 2),
        ...
        up1 = DeConv2d(up1, 64, (4, 4), out_size=(256, 256), strides=(2, 2),
        ...
        up0 = DeConv2d(up0, 64, (4, 4), out_size=(512, 512), strides=(2, 2),
